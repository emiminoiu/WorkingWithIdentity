...
namespace WorkingWithIdentity
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            SyncfusionLicenseProvider.RegisterLicense("@31372e312e30WXmJZcC00yGAkroFRHTGseMaoeg4L+im0K0JfgCf/lM=");
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddDefaultUI();
            ...
            {
                facebookOptions.AppId = "862566444136020";
                facebookOptions.AppSecret = "ffd231a3afdf7f6237d470cc965a3291";
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            //Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("@31372e312e30WXmJZcC00yGAkroFRHTGseMaoeg4L+im0K0JfgCf/lM=");
