...
namespace WorkingWithIdentity.Controllers
{
    public class GradesController : Controller
    {
        ...
        public IActionResult GetMyStudents(string GradeId)
        {
            var myStudents = _context.Students.Where(s => s.GradeId.Equals(GradeId));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("GradeId,GradeName")] Grade grade)
        {
            if (id != grade.Id)
            {
                return NotFound();
        ...
        {
            return _context.Grades.Any(e => e.Id.Equals(id));
        }
    }
}
